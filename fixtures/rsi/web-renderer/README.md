...
The wrapper disables actions and source reads while the snapshot is busy or a
local request is pending. A changed counter alone does not attest that the next
input ticket is usable; controlled busy/ready snapshots verify that distinction.
