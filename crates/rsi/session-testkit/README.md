...
The same scenario checks complete projection baselines, same-preset revision
notifications and publication through each adapter, alongside draft history,
idempotent mailbox acceptance, immutable
