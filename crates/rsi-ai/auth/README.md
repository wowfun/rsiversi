...
values. `SecretValue` never reveals itself through Debug or Display. A future
plugin adapter must supply credentials through its own explicit configuration
boundary; this standalone package has no active `rsi-meta` integration.
