//! Native ABI v3 execution adapter for explicit trusted artifact paths.
//!
...
#[cfg(test)]
pub(crate) fn resolved_test_factory<T: rsi_meta::PluginFactory>(
    factory: std::sync::Arc<T>,
) -> rsi_meta::ResolvedFactory {
...
pub(crate) use rsi_meta_native::MAX_DIAGNOSTIC_BYTES as MAX_NATIVE_DIAGNOSTIC_BYTES;
