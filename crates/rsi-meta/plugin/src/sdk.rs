//! Safe Rust authoring interface for ABI v2 plugins.
...
/// Exports one ABI v2 plugin entry backed by the safe SDK.
#[macro_export]
macro_rules! export_plugin {
    ($plugin:ty) => {
        ...
        #[doc = "# Safety"]
        #[doc = ""]
        #[doc = "The host and output pointers must satisfy the ABI v2 entry contract in `rsi_meta_plugin.h`."]
        pub unsafe extern "C" fn rsi_meta_plugin_entry_v2(
