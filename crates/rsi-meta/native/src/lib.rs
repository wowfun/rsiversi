//! Fixed-layout native ABI v3 wire types for trusted in-process plugins.
//!
...
compile_error!("rsi-meta native ABI v3 requires 64-bit pointers");
...
pub const PLUGIN_ENTRY_SYMBOL: &[u8] = b"rsi_meta_plugin_entry_v3\0";
