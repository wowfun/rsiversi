...
- Keep DRY and avoid restating anything that is already self-explanatory. Give each current contract (rather than change history) one authoritative README, rustdoc, schema, source, or subject document and link to it; [Agent Notes](.agents/notes/README.md) own durable decision rationale.
