...
Trusted-path-only loading remains current until this proposal ships. A Meta
installer would violate its generic ownership. Remote marketplaces and version
